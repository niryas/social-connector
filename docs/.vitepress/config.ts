...
export default defineConfig({
	...
	description: "Simple TypeScript / JavaScript integration with Instagram Basic Display API",
	themeConfig: {
		...
		sidebar: [
			{
				...
				items: [
					...
					{text: "Extending Social Connector", link: "/guide/extending"},
				],
			},
			{
				text: "Examples",
			...
			},
			{
				...
				items: [
					...
					{text: "SocialConnector", link: "/reference/social-connector"},
